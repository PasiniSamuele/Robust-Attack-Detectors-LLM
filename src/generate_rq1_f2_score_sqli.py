...
if gen_rq1:
    ...
    ax = sns.barplot(data=rag_improvement_df_gb, x = "model_temperature", y = "rag_improvement", palette = sns.color_palette(palette='cool', n_colors = len(rag_improvement_df_gb)))
