...
rq1_large_file = "rq1_large_f2_sqli.csv"
rq1_file = "rq1_f2_sqli.csv"



rq1_plot_folder = "rq1_plots_f2_sqli"
...
if gen_rq1:
    ...
    ax = sns.barplot(data=rag_improvement_df_gb, x = "model_temperature", y = "rag_improvement", palette = sns.color_palette(palette='BuGn', n_colors = len(rag_improvement_df_gb)))
