...
def add_parse_arguments(parser):
    ...
    parser.add_argument('--dataset_folder', type=str, default='data/synthetic_datasets_sap/task_detect_xss_simple_prompt/template_create_synthetic_dataset/prompt_parameters_medium_dataset/model_anthropic-claude-3-opus/generation_mode_rag_few_shot/n_few_shot_3/temperature_0.5/seed_156/run_0', help='synthetic dataset folder')
