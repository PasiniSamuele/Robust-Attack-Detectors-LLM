...
def add_parse_arguments(parser):
    ...
    parser.add_argument('--experiments_root_folder', type=str, default='experiments/task_detect_xss_simple_prompt/template_create_function_readable', help='root of the experiments')
    ...
    parser.add_argument('--output_file', type=str, default='experiments_summary_test.csv', help='name of the file containing the summary of the experiments')
